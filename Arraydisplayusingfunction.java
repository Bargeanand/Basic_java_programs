...
{      
    ...
    { 
        ...
        arrayInitialized(array,size,sc);//array calling
        //arrayDisplay(array,size);
        addElementinarray(array,size,sc);
        arrayDisplay(array,size);
        arraysum(array,size);
    ...
    public static void arrayInitialized(int[] array,int size,Scanner sc)//array defination
    {  
    ...
    public static void addElementinarray(int array[],int size,Scanner sc)
    {   
